...
$app->map(['GET','POST'],'/room_no',function(Request $request, Response $response){
    ...
    FROM AMSD.ASSETS_VW
    WHERE ASSET_CLASS LIKE '%$ASSET_CLASS%' AND ASSET_ID LIKE '%$ASSET_ID%' AND ASSET_ROOM_NO LIKE '%$ASSET_ROOM_NO%' AND ASSET_AREA LIKE '%$ASSET_LOCATION%' 
